...
declare module "web3" {
  ...
  export interface Subscribe<T> {
    ...
    /*  on(type: "data" , handler:(data:Transaction)=>void): void
      ...
      */
    on(type: "changed" | "data", handler: (data: T) => void): void;
    on(type: "error", handler: (data: Error) => void): void;
  }
  ...
  export interface Utils {
    ...
    leftPad(val: string, chars: number, sign: string): string;
    padLeft(val: string, chars: number, sign: string): string;
    rightPad(val: string, chars: number, sign: string): string;
    padRight(val: string, chars: number, sign: string): string;
    sha3(
      val: string,
      val2?: string,
      val3?: string,
  ...
  export class Eth {
    ...
    public getBlockTransactionCount(
      val: BlockType | string,
      cb?: Callback<number>
    ): Promise<number>;
    public getBlockUncleCount(
      val: BlockType | string,
      cb?: Callback<number>
    ): Promise<number>;
    public getCode(
    ...
    public getTransactionFromBlock(
      block: BlockType,
      index: number,
      cb?: Callback<Transaction>
    ): Promise<Transaction>;
  ...
  export class Net {
    public getId(cb?: Callback<number>): Promise<number>;
    public isListening(cb?: Callback<boolean>): Promise<boolean>;
    public getPeerCount(cb?: Callback<number>): Promise<number>;
  }
  export class Personal {
    ...
    public importRawKey(): Promise<string>;
    public lockAccount(): Promise<boolean>;
    public unlockAccount(): void;
    public sign(): Promise<string>;
    public ecRecover(message: string, sig: string): void;
    public sendTransaction(tx: Tx, passphrase: string): Promise<string>;
  }
  export class Shh {}
  export class Bzz {}
  ...
  export default class Web3 {
    ...
    public static givenProvider: Provider;
    ...
    public extend(methods: any): any; // TODO
